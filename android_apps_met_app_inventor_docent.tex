...
\end{enumerate}
Onderdeel van deze strategie is tevens het "programmeren door completeren" zoals beschreven door Merri몁boer (Merri몁boer 1992). Dit wordt doorgaans ook als een goede didactische aanpak gezien bij het beginnen met leren programmeren.
Verder hebben we gepoogd zoveel mogelijk van de zogenaamde Big Ideas van programmeren (zie Saeli 2012) aan bod te laten komen omdat Informatica docenten deze belangrijk vinden binnen het programmeeronderwijs:
...
\chapter{Referenties}
Kaasb퓄l, J.J. (1998). Exploring didactic models for programming. Tapir, pp. 195-203.

Merri몁boer, J.J.G. van (1992). Programmeren door completeren. TINFON, 1(2), pp. 66-71.
