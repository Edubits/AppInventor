...
De \menuitem{Blocks Editor} is een aparte applicatie die niet in je webbrowser draait. Je ziet in je taakbalk dan ook een \emph{App Inventor for Android Blocks Editor: MollenMeppen - Screen1} pictogram. Je kunt met `ALT-TAB' makkelijk wisselen tussen het \menuitem{Design} scherm en de \menuitem{Blocks Editor}.
\end{derivation}
